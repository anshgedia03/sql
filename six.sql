...
-- JOINS are used to combine rows from two or more tables based on the common column that we have .
...
--use of partition by is to divide the result into partitions(groups) and then aggregate functions can be applied
