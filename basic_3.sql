...
--2 .
SELECT * FROM emp WHERE salary = (SELECT max(salary) from emp) LIMIT 4 ;


 -- give me highest paid emp , age >= 25 

 SELECT * FROM emp WHERE age >= 25  ORDER BY salary DESC ;
...
UPDATE learners SET YearsOfExperience = 3 ,LearnerCompany = "Sony" WHERE Learner_Id = 1  ;